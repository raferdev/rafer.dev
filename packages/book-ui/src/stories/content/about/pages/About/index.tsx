...
// This page documents the rafer.dev project itself, so it's fine for these
// to be plain literals rather than importing the app's own config.
const siteUrl = 'https://rafer.dev'
const githubRepoUrl = 'https://github.com/raferdev/landing-page'
const profile = {
